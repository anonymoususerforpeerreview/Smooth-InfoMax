...
# example python call:
# python -m linear_classifiers.logistic_regression_syllables  final_zzzz/zzzz_full_audio_distribs_distr=true_kld=0 sim_audio_distr_false
# or
# python -m linear_classifiers.logistic_regression_syllables temp sim_audio_de_wwww_distr_true --overrides encoder_config.kld_weight=0.01 encoder_config.num_epochs=2 syllables_classifier_config.encoder_num=1 syllables_classifier_config.num_epochs=3 use_wandb=False train=True
...
def main():
    ...
    assert (opt.syllables_classifier_config.dataset.dataset in [Dataset.DE_wwww]), "Dataset not supported"
