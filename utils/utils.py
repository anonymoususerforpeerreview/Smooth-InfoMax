...
def get_nb_classes(dataset: Dataset, args: None):
    ...
    if dataset == Dataset.STL10:
        ...
        nb_classes = 4
    elif dataset == Dataset.DE_wwww and args == "vowels":
        nb_classes = 3
    elif dataset == Dataset.DE_wwww and args == "syllables":
        nb_classes = 9
    else:
...
def get_audio_classific_key(opt: OptionsConfig,
    ...
    """ONLY FOR DE_wwww DATASET. FOR LIBRI, USE get_audio_libri_classific_key() INSTEAD."""
