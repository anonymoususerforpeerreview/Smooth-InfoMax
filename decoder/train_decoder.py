# Example usage:
# python -m decoder.train_decoder temp sim_audio_de_wwww_distr_true
...
def main(model_type: ModelType = ModelType.ONLY_DOWNSTREAM_TASK):
    ...
    assert (decoder_config.dataset.dataset in [Dataset.DE_wwww, Dataset.LIBRISPEECH, Dataset.LIBRISPEECH_SUBSET]), "Dataset not supported"
